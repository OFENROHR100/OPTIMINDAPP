  ...
  return (
    <div className="Kontakt">
        ...
        <div class="kontaktcontainer">
            <div class='impressum'>
                <p className='hometitle3'>Impressum</p><br/>
                    <p>&nbsp;Angaben gemäß § 5 TMG</p>
                    <p>&nbsp;OPTIMIND Club - (Projekt des Vereins) Initiative Bildung in Zukunft e.V. (IBiZ)<br/> 
                    &nbsp;Cornelia-Schorer Str 5<br/> 
                    &nbsp;23562 Lübeck <br/> 
                    &nbsp;E-Mail: info@optimind-club.com<br/>
                    &nbsp;Tel.: +49 176 41051127
                    </p><br/>
                    <p> 
                    ...
                    <p><br/>
                    <strong>Webdesign und Programmierung</strong><br/>
                        &nbsp;Henri Mache</p>
